...
export default function RpteNuevo() {
  ...
  */
  ...
  const token='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjQiLCJyb2xlIjp7ImlkIjoiMiIsIm5hbWUiOiJTdHVkZW50In0sImlhdCI6MTczMDk5NzYxNCwiZXhwIjoxNzMxMDg0MDE0fQ.XeG9T8MUapD2uh_1xs1mYyQe-RwcTNdSA4CZPiDVgb0'

  const { datos } = useData(
    urlCategories,
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjQiLCJyb2xlIjp7ImlkIjoiMiIsIm5hbWUiOiJTdHVkZW50In0sImlhdCI6MTczMDk5NzYxNCwiZXhwIjoxNzMxMDg0MDE0fQ.XeG9T8MUapD2uh_1xs1mYyQe-RwcTNdSA4CZPiDVgb0"
  );
